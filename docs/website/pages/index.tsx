    ...
    <div className="container">
      ...
      <main className="main">
        <div className="hero">
          <Image
            className="hero-logo"
            src={`${basePath}/assets/images/oxygen-ui/oxygen-ui-logo.svg`}
            alt="Oxygen UI Logo"
            width={400}
            height={100}
          />
          <p className={clsx('hero-description', spaceGrotesk.className)}>
            ...
            <Image
              className="wso2-logo"
              src={`${basePath}/assets/images/logos/white/wso2.svg`}
              alt="wso2"
              width={50}
              height={20}
            />
        ...
        <div className="grid">
          ...
          >
            <h2>
              <Image
                src={`${basePath}/assets/images/oxygen-ui/guidelines-logo.svg`}
                alt="Guidelines Logo"
                width={20}
                height={20}
              />
        ...
        <div className="grid">
          <div className="examples">
            <a
              href={`${basePath}/${LINKS.examples.multiBrandIdentity}`}
              className="card"
              target="_blank"
              rel="noreferrer"
            >
      ...
      <footer className="footer">
        <a href="https://wso2.com/" target="_blank" rel="noopener noreferrer">
          Built with ❤️ by
          <Image src={`${basePath}/assets/images/logos/white/wso2.svg`} alt="WSO2" width={40} height={16} />
        </a>
      </footer>
    </div>
  );
