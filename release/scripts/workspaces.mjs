/**
 * This file contains code adapted from https://github.com/release-it-plugins/workspaces.
 * This contains the changes introduced this pull request: https://github.com/release-it-plugins/workspaces/pull/102.
 */
