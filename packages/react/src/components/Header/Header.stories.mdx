...
import {LanguagesIcon, LogsIcon, SunIcon, CresentBrightIcon} from '@oxygen-ui-experimental/react-icons';
...
<Source
  ...
  dark
  format
  code={dedent`import Header from '@oxygen-ui-experimental/react/Header';\n`}
/>
