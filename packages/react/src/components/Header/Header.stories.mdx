...
import {LanguagesIcon, SettingsIcon, SunIcon, CrescentBrightIcon, CommentIcon, SearchIcon} from '@oxygen-ui/react-icons';
...
export const leftAlignedElementsVariationOptions = {
  ...
  leftAlignedElements: [
    <Button color="inherit" startIcon={<SearchIcon />} href="/" id='search'>Search</Button>,
    <Button color="inherit" startIcon={<CommentIcon />} href="/" id='info'>Info</Button>]
};

export const rightAlignedElementsVariationOptions = {
  ...basicHeaderVariationOptions,
  rightAlignedElements: [
    <Button color="inherit" startIcon={<SettingsIcon />} href="/" id='console'>Console</Button>,
    <Button color="inherit" startIcon={<LanguagesIcon />} href="/" id='language'>Language</Button>
  ],
}
