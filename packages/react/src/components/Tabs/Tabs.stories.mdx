...
<Source
  ...
  format
  code={dedent`
import Tab from '@oxygen-ui-experimental/react/Tab';
import TabPanel from '@oxygen-ui-experimental/react/TabPanel';
import Tabs from '@oxygen-ui-experimental/react/Tabs';\n
function Demo() {
  return (
    <Box>
