 ...
 * 2.73:1 on white, so it is used only for decorative surfaces — the WSO2 mark
 * and the hover border. Any brand-colored *text* would need a darker shade;
 * the switcher has none.
 *
