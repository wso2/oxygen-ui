...
|-------|--------|-------------|
| Acrylic Orange | `AcrylicOrangeTheme` | Default theme with glass-morphism effects, orange primary |
...
Theme selection is automatically persisted to localStorage. The provider reads the saved theme on mount and applies it.
