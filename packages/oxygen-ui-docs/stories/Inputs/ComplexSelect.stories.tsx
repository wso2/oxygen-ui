      ...
      <Box sx={{ minWidth: 300 }}>
        ...
        >
          ...
          <ComplexSelect.MenuItem value="admin">
            ...
            <ComplexSelect.MenuItem.Text primary="Administrator" secondary="Full system access" />
          ...
          <ComplexSelect.MenuItem value="moderator">
            ...
            <ComplexSelect.MenuItem.Text primary="Moderator" secondary="Manage users and content" />
          </ComplexSelect.MenuItem>
          ...
          <ComplexSelect.MenuItem value="user">
            ...
            <ComplexSelect.MenuItem.Text primary="User" secondary="Standard access" />
          </ComplexSelect.MenuItem>
        </ComplexSelect>
      </Box>
    )
      ...
      <Box sx={{ minWidth: 320 }}>
        ...
        >
          ...
          <ComplexSelect.MenuItem value={0}>
            ...
            <ComplexSelect.MenuItem.Text primary="Sitemark-web" secondary="Web app" />
          </ComplexSelect.MenuItem>
          ...
          <ComplexSelect.MenuItem value={10}>
            ...
            <ComplexSelect.MenuItem.Text primary="Sitemark-app" secondary="Mobile application" />
          </ComplexSelect.MenuItem>
          ...
          <ComplexSelect.MenuItem value={20}>
            ...
            <ComplexSelect.MenuItem.Text primary="Sitemark-Store" secondary="Web app" />
          </ComplexSelect.MenuItem>
          ...
          <ComplexSelect.MenuItem value={30}>
            ...
            <ComplexSelect.MenuItem.Text primary="Sitemark-Admin" secondary="Web app" />
          </ComplexSelect.MenuItem>
          ...
          <ComplexSelect.MenuItem value={40}>
            ...
            <ComplexSelect.MenuItem.Text primary="Add product" secondary="Create new project" />
          </ComplexSelect.MenuItem>
        </ComplexSelect>
      </Box>
    )
      ...
      <Box sx={{ minWidth: 300 }}>
        ...
        >
          ...
          <ComplexSelect.MenuItem value="user1">
            ...
            <ComplexSelect.MenuItem.Text primary="John Doe" secondary="john.doe@example.com" />
          </ComplexSelect.MenuItem>
          ...
          <ComplexSelect.MenuItem value="user2">
            ...
            <ComplexSelect.MenuItem.Text primary="Jane Smith" secondary="jane.smith@example.com" />
          </ComplexSelect.MenuItem>
          ...
          <ComplexSelect.MenuItem value="user4" disabled>
            ...
            <ComplexSelect.MenuItem.Text primary="Alice Williams" secondary="Currently offline" />
          </ComplexSelect.MenuItem>
        </ComplexSelect>
      </Box>
    )
      ...
      <Box sx={{ minWidth: 300 }}>
        ...
        >
          ...
          <ComplexSelect.MenuItem value="team1">
            ...
            <ComplexSelect.MenuItem.Text primary="Frontend Team" secondary="React, TypeScript" />
          </ComplexSelect.MenuItem>
          ...
          <ComplexSelect.MenuItem value="team2">
            ...
            <ComplexSelect.MenuItem.Text primary="Backend Team" secondary="Node.js, Python" />
          </ComplexSelect.MenuItem>
          ...
          <ComplexSelect.MenuItem value="team3">
            ...
            <ComplexSelect.MenuItem.Text primary="UX Team" secondary="User research, prototyping" />
          </ComplexSelect.MenuItem>
          ...
          <ComplexSelect.MenuItem value="team4">
            ...
            <ComplexSelect.MenuItem.Text primary="UI Team" secondary="Visual design, branding" />
          </ComplexSelect.MenuItem>
          ...
          <ComplexSelect.MenuItem value="team5">
            ...
            <ComplexSelect.MenuItem.Text primary="DevOps Team" secondary="Infrastructure, CI/CD" />
          </ComplexSelect.MenuItem>
        </ComplexSelect>
      </Box>
    )
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3, minWidth: 300 }}>
        ...
        >
          ...
          <ComplexSelect.MenuItem value="moderator">
            ...
            <ComplexSelect.MenuItem.Text primary="Moderator" secondary="Manage users" />
          </ComplexSelect.MenuItem>
